...
public class AI_Card_Tool_EditorWindow : EditorWindow
{
    ...
    // TO DELETE
    public event Action<Texture2D,string, string> OnAIMatAndTexturePathsCreated = null;
    #endregion
    ...
    private void InitEvents()
    {
        ...
        //to delete transfered to AIFolderCreator_Editor
    ...
    // To delete
    // Currently not transfering the data, set directly inside StartChat method
